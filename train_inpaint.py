...
from ldm.data.dataset_mask import MaskDataset
...
def main():
    ...
    # dataset
    train_dataset = MaskDataset('train_inpaint_img.txt')
    ...
    #TODO:mask处理
            ...
            features_adapter = model_ad(data['im_masked'].to(device))
